// Custom Fork of mocha-junit-reporter
// Since cypress does not fire an even on tests skipped added logic to end suite even to add skipped tests.
"use strict";
...
try {
    const json = JSON.parse(fs.readFileSync(path.dirname(require.resolve("mocha")) + "/package.json", "utf8"));
